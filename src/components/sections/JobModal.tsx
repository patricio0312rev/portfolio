...
export function JobModal({ job, onClose }: JobModalProps) {
  ...
  const Content = (
    <div className="min-w-0">
                  ...
                  {project.technologies && project.technologies.length > 0 && (
                    <div className="mt-4 flex flex-wrap gap-2">
                      {project.technologies.map((tech) => (
                        <TechBadge key={tech} techId={tech} variant="default" />
                      ))}
                    </div>
                  )}
                </div>
      ...
      {!activeProject && job.achievements && job.achievements.length > 0 && (
        <div className="mb-6">
      ...
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-3">
          {activeProject ? "Technologies (Project)" : "Technologies Used"}
        </h3>
